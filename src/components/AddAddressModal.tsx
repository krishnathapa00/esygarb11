      ...
      <DialogContent>
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div>
            ...
            <Input id="type" name="type" value={form.type} onChange={handleChange} placeholder="Home, Work, etc." />
          </div>
          <div>
            <Label htmlFor="street">Street</Label>
            <Input id="street" name="street" value={form.street} onChange={handleChange} placeholder="Street address" />
          </div>
          <div>
          ...
          <div>
            ...
            <Input id="zip_code" name="zip_code" value={form.zip_code} onChange={handleChange} placeholder="Pincode" />
          </div>
