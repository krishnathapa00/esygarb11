...
const LocationDetectionPopup = ({
  isOpen,
  onClose,
  onLocationSet,
}: LocationDetectionPopupProps) => {
          ...
          <div className="space-y-6 p-4">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                To provide you with the best delivery experience, please set
                your location with high accuracy GPS.
              </p>
            </div>
