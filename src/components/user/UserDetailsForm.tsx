...
import { GPSPermissionPopup } from "../delivery";
        ...
        try {
          ...
          if (!isInNepal) {
            ...
            toast({
              ...
              description:
                "Sorry, we are not available in your city. EsyGrab currently serves Nepal only.",
              variant: "destructive",
            });
            return;
          }
          ...
          if (response.ok) {
            ...
            toast({
              ...
              description:
                "Your delivery address has been updated with high accuracy",
            });
          } else {
            console.log("Geocoding failed, using coordinates");
            const fallbackLocation = `Lat: ${lat.toFixed(
              4
            )}, Lng: ${lng.toFixed(4)}`;
            ...
            toast({
              title: "Location detected",
              description:
                "Your location has been detected. Please refine the address if needed.",
            });
          }
        } catch (error) {
          console.error("Geocoding error:", error);
          const fallbackLocation = `Lat: ${position.coords.latitude.toFixed(
            4
