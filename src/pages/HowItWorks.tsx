...
import { ArrowLeft, Search, ShoppingCart, MapPin, CreditCard, Truck } from 'lucide-react';
  ...
  const steps = [
    {
      ...
      description: "Browse our wide range of groceries and essentials through the EsyGrab website.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: <ShoppingCart className="h-8 w-8 text-white" />,
      title: "Add to Cart",
      description: "Add your favorite items to the cart with just a few clicks.",
      color: "from-green-500 to-green-600"
    },
    {
      icon: <MapPin className="h-8 w-8 text-white" />,
      title: "Confirm Address",
      description: "Confirm your delivery address and apply promo codes if available.",
        ...
        <div className="bg-white rounded-lg p-8 shadow-sm mt-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">Fresh products sourced from trusted suppliers with quality assurance.</p>
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 mb-2">📱 Easy to Use</h4>
              <p className="text-gray-600 text-sm">Simple and intuitive interface that makes shopping a breeze.</p>
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 mb-2">💰 Great Prices</h4>
              <p className="text-gray-600 text-sm">Competitive prices with regular discounts and promo codes.</p>
            </div>
          </div>
        </div>
      </div>
