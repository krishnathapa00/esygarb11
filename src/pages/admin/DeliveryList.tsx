      ...
      const { data, error } = await supabase
        ...
        .select(`
          *,
          ...
          total_orders:orders!delivery_partner_id(count)
        `)
                  ...
                  <tr key={person.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">
                        <span className="font-medium">{person.assigned_orders?.[0]?.count || 0}</span> active
                      </div>
                      <div className="text-xs text-gray-500">
                        {person.total_orders?.[0]?.count || 0} total delivered
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
