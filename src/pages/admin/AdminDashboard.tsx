...
import { BarChart3, ShoppingBag, Users, TrendingUp, Package, UserCheck, Clock } from 'lucide-react';
            ...
            <CardContent>
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-xs text-green-600">+₹{dashboardData.revenueToday} today</p>
                </div>
                ...
                {[1, 2, 3, 4, 5].map((index) => (
                  <div key={index} className="flex justify-between items-center border-b pb-2">
                    <div>
                      ...
                      <p className="text-xs text-gray-500">June {6-index}, 2025 • ₹{Math.floor(Math.random() * 500) + 100}</p>
                    </div>
