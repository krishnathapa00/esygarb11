    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="px-4 py-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Learn about our return policy</p>
                </div>
              </div>
            </div>
          </Link>
        ...
        <div className="bg-white rounded-lg p-8 shadow-sm">
          <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Contact Our Support Team</h3>
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-6 mt-8">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold text-green-800 mb-2">Support Hours</h4>
              <p className="text-green-700 text-sm">
                Our customer support team is available 7 days a week from 7:00 AM to 10:00 PM.
                For urgent issues outside these hours, please email us and we'll respond as soon as possible.
              </p>
            </div>
          </div>
        </div>
