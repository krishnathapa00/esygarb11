      ...
      <div className="px-4 py-4 max-w-md mx-auto lg:max-w-4xl lg:px-8">
        ...
        <div className="space-y-4 lg:grid lg:grid-cols-3 lg:gap-6 lg:space-y-0">
          ...
          <div className="bg-white rounded-lg p-4 shadow-sm lg:h-fit">
            ...
            <Link to="/checkout">
              <Button className="w-full py-3 text-base font-medium bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white">
                Proceed to Checkout
              </Button>
            </Link>
          </div>
